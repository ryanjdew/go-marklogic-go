...
func (s *Service) ListExtensions(directory string, response handle.Handle) error {
	return listExtensions(s.client, directory, response)
}

// DeleteExtensions removes all the installed REST extensions under teh provided path
func (s *Service) DeleteExtensions(directory string, response handle.Handle) error {
	return deleteExtensions(s.client, directory, response)
}

// CreateExtension shows all the installed REST extensions
func (s *Service) CreateExtension(assetName string, resource io.Reader, extensionType string, options map[string]string, response handle.Handle) error {
