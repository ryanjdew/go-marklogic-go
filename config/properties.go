...
func getProperties(c *clients.Client, response handle.Handle) error {
...
func setProperties(c *clients.Client, properties handle.Handle, response handle.Handle) error {
...
func resetProperties(c *clients.Client, response handle.Handle) error {
...
func setPropertyValue(c *clients.Client, propertyName string, property handle.Handle, response handle.Handle) error {
