...
func listTransforms(c *clients.Client, response handle.Handle) error {
...
func getTransformInfo(c *clients.Client, name string, response handle.Handle) error {
...
func createTransform(c *clients.Client, name string, resource io.Reader, extensionType string, options map[string]string, response handle.Handle) error {
...
func deleteTransform(c *clients.Client, name string, response handle.Handle) error {
